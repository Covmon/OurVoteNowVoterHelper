...
def xlsx_to_csv(election_date,election_type_filler):
	...
	overall_total_registered_dataframe_transpose = pd.DataFrame(columns=[u'COUNTY NAME', u'18-24', u'25-29', u'30-34', u'35-39', u'40-44', u'45-49', u'50-54', u'55-59',
       u'60-64', u'TOTAL'])
	overall_total_voted_dataframe_transpose = pd.DataFrame(columns=[u'COUNTY NAME', u'18-24', u'25-29', u'30-34', u'35-39', u'40-44', u'45-49', u'50-54', u'55-59',
       u'60-64', u'TOTAL'])
	...
	for district in range(1,15):
		...
		if election_type_filler != 'primary':
			df = pd.read_excel('/Users/sammahle/Desktop/OurVoteNowVoterHelper/Georgia_Election_Data_Source_XLSX/{}/{}(CongressionalDistricts){}/{}.xlsx'.format(year,election_date,election_type_filler,district_3fill))
			df = df.iloc[1:]
			...
			df_voted.rename(columns={'GEORGIA':'COUNTY NAME'},inplace=True)
			df_percentage_voted.rename(columns={'GEORGIA':'COUNTY NAME'},inplace=True)
			df_voted = df_voted.iloc[1:]
			df_percentage_voted = df_percentage_voted.iloc[1:]
			df_total_registered = df_total_registered.iloc[1:]
			df_total_registered.rename(columns={'GEORGIA':'COUNTY NAME'},inplace=True)

		elif election_type_filler == 'primary':
			df_dem = pd.read_excel('/Users/sammahle/Desktop/OurVoteNowVoterHelper/Georgia_Election_Data_Source_XLSX/{}/{}(CongressionalDistricts){}/{}.xlsx'.format(year,election_date,'/DEM',district_3fill))
			df_rep = pd.read_excel('/Users/sammahle/Desktop/OurVoteNowVoterHelper/Georgia_Election_Data_Source_XLSX/{}/{}(CongressionalDistricts){}/{}.xlsx'.format(year,election_date,'/REP',district_3fill))
			...
			df_voted_dem.rename(columns={'Unnamed: 45': u'NATIVE-AM UNKNOWN', 'Unnamed: 54': u'OTHER UNKNOWN', 'Unnamed: 6': u'BLACK FEMALE', 'Unnamed: 3': u'BLACK MALE', 'Unnamed: 9': u'BLACK UNKNOWN', 'Unnamed: 27': u'ASIA-PI UNKNOWN', 'Unnamed: 24': u'ASIA-PI FEMALE', 'Unnamed: 21': u'ASIA-PI MALE', 'Unnamed: 63': u'UNKNOWN', 'Unnamed: 60': u'UNKNOWN FEMALE', 'Unnamed: 66': u'TOTAL', 'Unnamed: 42': u'NATIVE-AM FEMALE', 'Unnamed: 48': u'OTHER MALE', 'GEORGIA SECRETARY OF STATE\nSSVRZ521R1 VOTER REGISTRATION SYSTEM SECRETARY OF STATE\nACTIVE/INACTIVE VOTERS BY RACE/GENDER/DISTRICT\nGENERAL ELECTION VOTING HISTORY SUMMARY\nELECTION DATE: {} '.format(formatted_date).replace('\\n','\n').replace('/INACTIVE',''): u'AGE GROUP', 'Unnamed: 15': u'WHITE FEMALE', 'Unnamed: 12': u'WHITE MALE', 'Unnamed: 39': u'NATIVE-AM MALE', 'Unnamed: 36': u'HISP-LT UNKNOWN', 'Unnamed: 51': u'OTHER FEMALE', 'Unnamed: 30': u'HISP-LT MALE', 'Unnamed: 57': u'UNKNOWN MALE', 'Unnamed: 18': u'WHITE UNKNOWN', 'Unnamed: 33': u'HISP-LT FEMALE'},inplace=True)
			df_percentage_voted_dem.rename(columns={'Unnamed: 4': u'BLACK MALE', 'Unnamed: 7': u'BLACK FEMALE', 'Unnamed: 28': u'ASIA-PI UNKNOWN', 'Unnamed: 25': u'ASIA-PI FEMALE', 'Unnamed: 22': u'ASIA-PI MALE', 'Unnamed: 61': u'UNKNOWN FEMALE', 'Unnamed: 46': u'NATIVE-AM UNKNOWN', 'Unnamed: 67': u'TOTAL', 'Unnamed: 40': u'NATIVE-AM MALE', 'Unnamed: 43': u'NATIVE-AM FEMALE', 'Unnamed: 64': u'UNKNOWN', 'Unnamed: 49': u'OTHER MALE', 'Unnamed: 34': u'HISP-LT FEMALE', 'Unnamed: 55': u'OTHER UNKNOWN', 'GEORGIA SECRETARY OF STATE\nSSVRZ521R1 VOTER REGISTRATION SYSTEM SECRETARY OF STATE\nACTIVE/INACTIVE VOTERS BY RACE/GENDER/DISTRICT\nGENERAL ELECTION VOTING HISTORY SUMMARY\nELECTION DATE: {} '.format(formatted_date).replace('\\n','\n').replace('/INACTIVE',''): u'AGE GROUP', 'Unnamed: 16': u'WHITE FEMALE', 'Unnamed: 58': u'UNKNOWN MALE', 'Unnamed: 13': u'WHITE MALE', 'Unnamed: 10': u'BLACK UNKNOWN', 'Unnamed: 52': u'OTHER FEMALE', 'Unnamed: 37': u'HISP-LT UNKNOWN', 'Unnamed: 31': u'HISP-LT MALE', 'Unnamed: 19': u'WHITE UNKNOWN'},inplace=True)
			...
			df_voted_rep.rename(columns={'Unnamed: 45': u'NATIVE-AM UNKNOWN', 'Unnamed: 54': u'OTHER UNKNOWN', 'Unnamed: 6': u'BLACK FEMALE', 'Unnamed: 3': u'BLACK MALE', 'Unnamed: 9': u'BLACK UNKNOWN', 'Unnamed: 27': u'ASIA-PI UNKNOWN', 'Unnamed: 24': u'ASIA-PI FEMALE', 'Unnamed: 21': u'ASIA-PI MALE', 'Unnamed: 63': u'UNKNOWN', 'Unnamed: 60': u'UNKNOWN FEMALE', 'Unnamed: 66': u'TOTAL', 'Unnamed: 42': u'NATIVE-AM FEMALE', 'Unnamed: 48': u'OTHER MALE', 'GEORGIA SECRETARY OF STATE\nSSVRZ521R1 VOTER REGISTRATION SYSTEM SECRETARY OF STATE\nACTIVE/INACTIVE VOTERS BY RACE/GENDER/DISTRICT\nGENERAL ELECTION VOTING HISTORY SUMMARY\nELECTION DATE: {} '.format(formatted_date).replace('\\n','\n').replace('/INACTIVE',''): u'AGE GROUP', 'Unnamed: 15': u'WHITE FEMALE', 'Unnamed: 12': u'WHITE MALE', 'Unnamed: 39': u'NATIVE-AM MALE', 'Unnamed: 36': u'HISP-LT UNKNOWN', 'Unnamed: 51': u'OTHER FEMALE', 'Unnamed: 30': u'HISP-LT MALE', 'Unnamed: 57': u'UNKNOWN MALE', 'Unnamed: 18': u'WHITE UNKNOWN', 'Unnamed: 33': u'HISP-LT FEMALE'},inplace=True)
			df_percentage_voted_rep.rename(columns={'Unnamed: 4': u'BLACK MALE', 'Unnamed: 7': u'BLACK FEMALE', 'Unnamed: 28': u'ASIA-PI UNKNOWN', 'Unnamed: 25': u'ASIA-PI FEMALE', 'Unnamed: 22': u'ASIA-PI MALE', 'Unnamed: 61': u'UNKNOWN FEMALE', 'Unnamed: 46': u'NATIVE-AM UNKNOWN', 'Unnamed: 67': u'TOTAL', 'Unnamed: 40': u'NATIVE-AM MALE', 'Unnamed: 43': u'NATIVE-AM FEMALE', 'Unnamed: 64': u'UNKNOWN', 'Unnamed: 49': u'OTHER MALE', 'Unnamed: 34': u'HISP-LT FEMALE', 'Unnamed: 55': u'OTHER UNKNOWN', 'GEORGIA SECRETARY OF STATE\nSSVRZ521R1 VOTER REGISTRATION SYSTEM SECRETARY OF STATE\nACTIVE/INACTIVE VOTERS BY RACE/GENDER/DISTRICT\nGENERAL ELECTION VOTING HISTORY SUMMARY\nELECTION DATE: {} '.format(formatted_date).replace('\\n','\n').replace('/INACTIVE',''): u'AGE GROUP', 'Unnamed: 16': u'WHITE FEMALE', 'Unnamed: 58': u'UNKNOWN MALE', 'Unnamed: 13': u'WHITE MALE', 'Unnamed: 10': u'BLACK UNKNOWN', 'Unnamed: 52': u'OTHER FEMALE', 'Unnamed: 37': u'HISP-LT UNKNOWN', 'Unnamed: 31': u'HISP-LT MALE', 'Unnamed: 19': u'WHITE UNKNOWN'},inplace=True)
			df_total_registered_rep.rename(columns={'Unnamed: 44': u'NATIVE-AM UNKNOWN', 'Unnamed: 5': u'BLACK FEMALE', 'Unnamed: 2': u'BLACK MALE', 'Unnamed: 8': u'BLACK UNKNOWN', 'Unnamed: 29': u'HISP-LT MALE', 'Unnamed: 26': u'ASIA-PI UNKNOWN', 'Unnamed: 23': u'ASIA-PI FEMALE', 'Unnamed: 20': u'ASIA-PI MALE', 'Unnamed: 62': u'UNKNOWN', 'Unnamed: 47': u'OTHER MALE', 'Unnamed: 41': u'NATIVE-AM FEMALE', 'Unnamed: 65': u'TOTAL', 'Unnamed: 53': u'OTHER UNKNOWN', 'GEORGIA SECRETARY OF STATE\nSSVRZ521R1 VOTER REGISTRATION SYSTEM SECRETARY OF STATE\nACTIVE/INACTIVE VOTERS BY RACE/GENDER/DISTRICT\nGENERAL ELECTION VOTING HISTORY SUMMARY\nELECTION DATE: {} '.format(formatted_date).replace('\\n','\n').replace('/INACTIVE',''): u'AGE GROUP', 'Unnamed: 17': u'WHITE UNKNOWN', 'Unnamed: 14': u'WHITE FEMALE', 'Unnamed: 59': u'UNKNOWN FEMALE', 'Unnamed: 38': u'NATIVE-AM MALE', 'Unnamed: 11': u'WHITE MALE', 'Unnamed: 35': u'HISP-LT UNKNOWN', 'Unnamed: 50': u'OTHER FEMALE', 'Unnamed: 56': u'UNKNOWN MALE', 'Unnamed: 32': u'HISP-LT FEMALE'},inplace=True)
			
			df_total_registered_dem.fillna(0,inplace=True)
			df_voted_dem.fillna(0,inplace=True)			
			df_total_registered_rep.fillna(0,inplace=True)
			df_voted_rep.fillna(0,inplace=True)

			df_voted_dem = df_voted_dem.iloc[1:]
			df_total_registered_dem = df_total_registered_dem.iloc[1:]
			df_voted_rep = df_voted_rep.iloc[1:]
			df_total_registered_rep = df_total_registered_rep.iloc[1:]

			df_voted = df_voted_dem[df_voted_dem.columns[1:]].astype(int).add(df_voted_rep[df_voted_rep.columns[1:]].astype(int), fill_value=0)
			df_voted.insert(loc=0,column='COUNTY NAME',value=df_voted_dem['GEORGIA'])
			...
			df_percentage_voted.insert(loc=0,column='COUNTY NAME',value=df_voted_dem['GEORGIA'])
	...
	df_divided = overall_total_voted_dataframe[overall_total_voted_dataframe.columns[1:]]/overall_total_registered_dataframe[overall_total_registered_dataframe.columns[1:]]
	...
	"""for county in ga_counties:
		...
		if county == 'DEKALB':
			if election_type_filler != 'primary':
				...
				df_rep = pd.read_excel('/Users/sammahle/Desktop/OurVoteNowVoterHelper/Georgia_Election_Data_Source_XLSX/{}/{}(CountyPrecinct){}/{}.xlsx'.format(year,election_date,'/REP',district))
				df_rep = df_rep.iloc[1:]
				df_dem = df_dem.iloc[1:]
	...
	for county in ga_counties:
		...
		if election_type_filler != 'primary':
			...
			df_dem = pd.read_excel('/Users/sammahle/Desktop/OurVoteNowVoterHelper/Georgia_Election_Data_Source_XLSX/{}/{}(Age){}/{}.xlsx'.format(year,election_date,'/DEM',district))
			df_rep = pd.read_excel('/Users/sammahle/Desktop/OurVoteNowVoterHelper/Georgia_Election_Data_Source_XLSX/{}/{}(Age){}/{}.xlsx'.format(year,election_date,'/REP',district))
			df_rep = df_rep.iloc[1:]
			df_dem = df_dem.iloc[1:]
			...
			df_voted = df_voted_dem[df_voted_dem.columns[1:]].astype(int).add(df_voted_rep[df_voted_rep.columns[1:]].astype(int), fill_value=0)
			df_voted.insert(loc=0,column='AGE GROUP',value=df_voted_dem['GEORGIA'])
			df_total_registered = df_total_registered_dem
			df_total_registered.rename(columns={'GEORGIA':'AGE GROUP'},inplace=True)
			df_percentage_voted = df_voted[df_voted.columns[1:]].astype(int)*100/df_total_registered[df_total_registered.columns[1:]].astype(int)
			df_percentage_voted = df_percentage_voted.round(2)
			df_percentage_voted.insert(loc=0,column='AGE GROUP',value=df_voted_dem['GEORGIA'])
	...
	overall_total_registered_dataframe_transpose = overall_total_registered_dataframe_transpose[[u'COUNTY NAME',   u'18-24',    u'25-29',       u'30-34',       u'35-39',
             u'40-44',       u'45-49',       u'50-54',       u'55-59',
             u'60-64',       u'65-OVER',       u'TOTAL']]
	overall_total_voted_dataframe_transpose = overall_total_voted_dataframe_transpose[[u'COUNTY NAME',  u'18-24',      u'25-29',       u'30-34',       u'35-39',
             u'40-44',       u'45-49',       u'50-54',       u'55-59',
             u'60-64',       u'65-OVER',       u'TOTAL']]
	overall_percent_voted_dataframe_transpose = overall_percent_voted_dataframe_transpose[[u'COUNTY NAME',    u'18-24',    u'25-29',       u'30-34',       u'35-39',
             u'40-44',       u'45-49',       u'50-54',       u'55-59',
             u'60-64',       u'65-OVER',       u'TOTAL']]
	...
	df_divided = overall_total_voted_dataframe_transpose[overall_total_voted_dataframe_transpose.columns[1:]]/overall_total_registered_dataframe_transpose[overall_total_registered_dataframe_transpose.columns[1:]]
	pd_seires = pd.Series(df_divided.loc[len(df_divided)-1]).astype(float)
	pd_seires = (pd_seires*100).round(2)
	pd_seires['COUNTY NAME'] = 'TOTAL'
	...
	overall_total_age_registered_dataframe = pd.DataFrame(columns=[u'TOTAL', u'UNKNOWN', u'UNKNOWN FEMALE',
	       ...
	       u'WHITE UNKNOWN', u'WHITE FEMALE', u'WHITE MALE', u'BLACK UNKNOWN',
	       u'BLACK FEMALE', u'BLACK MALE'])
	overall_total_age_voted_dataframe = pd.DataFrame(columns=[u'TOTAL', u'UNKNOWN', u'UNKNOWN FEMALE',
	       u'UNKNOWN MALE', u'OTHER UNKNOWN', u'OTHER FEMALE', u'OTHER MALE',
	       u'NATIVE-AM UNKNOWN', u'NATIVE-AM FEMALE', u'NATIVE-AM MALE',
	       u'HISP-LT UNKNOWN', u'HISP-LT FEMALE', u'HISP-LT MALE',
	       u'ASIA-PI UNKNOWN', u'ASIA-PI FEMALE', u'ASIA-PI MALE',
	       u'WHITE UNKNOWN', u'WHITE FEMALE', u'WHITE MALE', u'BLACK UNKNOWN',
	       u'BLACK FEMALE', u'BLACK MALE'])
	overall_total_age_percent_voted_dataframe = pd.DataFrame(columns=[u'TOTAL', u'UNKNOWN', u'UNKNOWN FEMALE',
	       u'UNKNOWN MALE', u'OTHER UNKNOWN', u'OTHER FEMALE', u'OTHER MALE',
	       u'NATIVE-AM UNKNOWN', u'NATIVE-AM FEMALE', u'NATIVE-AM MALE',
	       u'HISP-LT UNKNOWN', u'HISP-LT FEMALE', u'HISP-LT MALE',
	       u'ASIA-PI UNKNOWN', u'ASIA-PI FEMALE', u'ASIA-PI MALE',
	...
	for county in ga_counties:
		...
		county_total_age_registered_dataframe = pd.read_csv('/Users/sammahle/Desktop/OurVoteNowVoterHelper/Georgia_Election_Data_CSVs/{}/{}/County/{}_total_registered.csv'.format(year,election_type,county.upper()))
		county_total_age_voted_dataframe = pd.read_csv('/Users/sammahle/Desktop/OurVoteNowVoterHelper/Georgia_Election_Data_CSVs/{}/{}/County/{}_total_voted.csv'.format(year,election_type,county.upper()))

		overall_total_age_voted_dataframe = overall_total_age_voted_dataframe[overall_total_age_voted_dataframe.columns].astype(int).add(county_total_age_voted_dataframe[county_total_age_voted_dataframe.columns[1:]].astype(int), fill_value=0)
		overall_total_age_registered_dataframe = overall_total_age_registered_dataframe[overall_total_age_registered_dataframe.columns].astype(int).add(county_total_age_registered_dataframe[county_total_age_registered_dataframe.columns[1:]].astype(int), fill_value=0)
		
	overall_total_age_voted_dataframe.insert(loc=0,column='AGE GROUP',value=[u'18-24',      u'25-29',       u'30-34',       u'35-39',
             u'40-44',       u'45-49',       u'50-54',       u'55-59',
             u'60-64',       u'65-OVER',       u'TOTAL'])
	overall_total_age_registered_dataframe.insert(loc=0,column='AGE GROUP',value=[u'18-24',      u'25-29',       u'30-34',       u'35-39',
             u'40-44',       u'45-49',       u'50-54',       u'55-59',
             u'60-64',       u'65-OVER',       u'TOTAL'])
	
	overall_total_age_voted_dataframe = overall_total_age_voted_dataframe[[u'AGE GROUP', u'UNKNOWN', u'UNKNOWN FEMALE',
	       u'UNKNOWN MALE', u'OTHER UNKNOWN', u'OTHER FEMALE', u'OTHER MALE',
	       u'NATIVE-AM UNKNOWN', u'NATIVE-AM FEMALE', u'NATIVE-AM MALE',
	       u'HISP-LT UNKNOWN', u'HISP-LT FEMALE', u'HISP-LT MALE',
	       u'ASIA-PI UNKNOWN', u'ASIA-PI FEMALE', u'ASIA-PI MALE',
	       u'WHITE UNKNOWN', u'WHITE FEMALE', u'WHITE MALE', u'BLACK UNKNOWN',
	       u'BLACK FEMALE', u'BLACK MALE', u'TOTAL']]
	overall_total_age_registered_dataframe = overall_total_age_registered_dataframe[[u'AGE GROUP', u'UNKNOWN', u'UNKNOWN FEMALE',
	       u'UNKNOWN MALE', u'OTHER UNKNOWN', u'OTHER FEMALE', u'OTHER MALE',
	       u'NATIVE-AM UNKNOWN', u'NATIVE-AM FEMALE', u'NATIVE-AM MALE',
	       u'HISP-LT UNKNOWN', u'HISP-LT FEMALE', u'HISP-LT MALE',
	       u'ASIA-PI UNKNOWN', u'ASIA-PI FEMALE', u'ASIA-PI MALE',
