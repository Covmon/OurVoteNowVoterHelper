...
def xlsx_to_csv(election_date):
	...
	for district in range(1,15):
		...
		df = pd.read_excel('/Users/sammahle/Desktop/OurVoteNowVoterHelper/Georgia_Election_Data_Source_XLSX/{}/{}(Congressional Districts)/0{}.xlsx'.format(election_date,district))
		df = df.iloc[1:]
		...
		df_total_registered.to_csv('/Users/sammahle/Desktop/OurVoteNowVoterHelper/Georgia_Election_Data_CSVs/{}/{}/Congressional/US{}_total_registered.csv'.format(year,election_type,district),index=None).format()
	...
	overall_total_registered_dataframe.to_csv('/Users/sammahle/Desktop/OurVoteNowVoterHelper/Georgia_Election_Data_CSVs/{}/{}/{}(Congressional Districts)/Congressional_total_registered.csv'.format(year,election_type,district),index=None)
	overall_total_voted_dataframe.to_csv('/Users/sammahle/Desktop/OurVoteNowVoterHelper/Georgia_Election_Data_CSVs/{}/{}/{}(Congressional Districts)/Congressional_total_voted.csv'.format(year,election_type,district),index=None)
	overall_percent_voted_dataframe.to_csv('/Users/sammahle/Desktop/OurVoteNowVoterHelper/Georgia_Election_Data_CSVs/{}/{}/{}(Congressional Districts)/Congressional_percent_voted.csv'.format(year,election_type,district),index=None)
	...
	for precinct in ga_counties:
		...
		df = pd.read_excel('/Users/sammahle/Desktop/OurVoteNowVoterHelper/Georgia_Election_Data_Source_XLSX/{}/{}(County Precinct)/{}.xlsx'.format(election_date,district))
		df = df.iloc[1:]
		...
		df_percentage_voted.to_csv('/Users/sammahle/Desktop/OurVoteNowVoterHelper/Georgia_Election_Data_CSVs/{}/{}/Precinct/{}_percent_voted.csv'.format(year,election_type,district),index=None)
	...
	for county in ga_counties:
		...
		df = pd.read_excel('/Users/sammahle/Desktop/OurVoteNowVoterHelper/Georgia_Election_Data_Source_XLSX/{}/{}(Age)/{}.xlsx'.format(election_date,district))
		df = df.iloc[1:]
